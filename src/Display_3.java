...
public class Display_3 {
    ...
    Game_back_end_2 G = new Game_back_end_2();
    Coordinate C = new Coordinate();
    Animation A = new Animation();
    Timer T = new Timer();
    Score SC = new Score();

    int Marked_flag_x[] = new int[20];
    ...
    boolean Marked_flag_check[][] = new boolean[20][9];
    ...
    boolean Suggestion_coordinate[][] = new boolean[20][9];
    ...
    private void Display_content() {
        ...
        Zoom_red_square_2 Z = new Zoom_red_square_2();
        ...
        while (true) {
            ...
            if (Reset == 2) {
                while (true) {
                    ...
                    if (StdDraw.isMousePressed()) {
                        ...
                        if ((750 <= Reset_x_mouse && Reset_x_mouse <= 950) && (430 <= Reset_y_mouse && Reset_y_mouse <= 510)) {
                            Reset_choice = 1;
                            break;
                        }

                        if ((1050 <= Reset_x_mouse && Reset_x_mouse <= 1250) && (430 <= Reset_y_mouse && Reset_y_mouse <= 510)) {
                            Reset_choice = 2;
                            break;
                        }
                    }

                    A.Reset_screen(1000, 500);
                    A.Yes(850, 470);
                    A.No(1150, 470);
            ...
            if (Reset_choice == 1) {
                StdDraw.setPenColor(StdDraw.WHITE);
                StdDraw.rectangle(850, 470, 99, 39);
                StdDraw.show();
                StdDraw.pause(10);
                A.Yes(850, 470);
                StdDraw.show();
            ...
            if (Reset_choice == 2) {
                ...
                StdDraw.setPenColor(StdDraw.WHITE);
                StdDraw.rectangle(1150, 470, 99, 39);
                StdDraw.show();
                StdDraw.pause(10);
                A.No(1150, 470);
                StdDraw.show();
        ...
        if (Game_over) {
            ...
            while (Play_again_check_1 <= 10 && Menu_check_1 <= 10) {
                ...
                if (StdDraw.isMousePressed()) {
                    if ((1075 <= Mouse_x && Mouse_x <= 1425) && (100 <= Mouse_y && Mouse_y <= 200)) {
                        Play_again_check_2 = true;
                        Reset_choice = 1;

                    } else if ((575 <= Mouse_x && Mouse_x <= 925) && (100 <= Mouse_y && Mouse_y <= 200)) {
                        Menu_check = true;
                    }
                }
                ...
                StdDraw.text(1000, 500, "" + Offical_score);
                ...
                A.Play_again(1250, 150);
                if (1 <= Play_again_check_1 && Play_again_check_1 <= 5) {
                    StdDraw.setPenColor(StdDraw.WHITE);
                    StdDraw.rectangle(1249, 149, 174, 48);
                }
